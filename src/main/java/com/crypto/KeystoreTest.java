...
public class KeystoreTest {
    ...
    private static void createKeyStore() throws GeneralSecurityException, IOException, OperatorCreationException {
    ...
    private static X509Certificate generateRootCert(KeyPair pair) throws IOException, OperatorCreationException, CertificateException {
