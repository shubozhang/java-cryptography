...
public class BitcoinTransactionSigningDemo {
    ...
    public static void main(String[] args) throws GeneralSecurityException, DecoderException {
        new BitcoinTransactionSigningDemo().testAsymmetricSigningWithSignatureClasses();
    }


    private void testAsymmetricSigningWithSignatureClasses() throws GeneralSecurityException, DecoderException {
